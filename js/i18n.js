...
window.I18nManager = {
    ...
    data: {
      strings: {
        ...
        label_remove_less_than: "Remove items with less than",
        label_clicks_text: "clicks",
        btn_remove: "Remove",
        confirm_remove_low_clicks: "Are you sure you want to remove items with less than {count} clicks?",
        alert_items_removed: "Removed {count} item(s) successfully!",
        alert_no_items_removed: "No items found with less than {count} clicks.",
        alert_invalid_clicks: "Please enter a valid number of clicks.",
      },
      greetingRules: {
        morningStart: 5,
        morningEnd: 12,
