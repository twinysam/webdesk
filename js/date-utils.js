...
(function(scope) {
    scope.DateUtils = {
      ...
      THEME_PRESETS: {
        winter: { bg: "#016293", pattern: "#014669", link: "#83d3fa", linkHover: "#c4eafd", highlight: "#93007c" },
        spring: { bg: "#2d6a4f", pattern: "#1b4332", link: "#95d5b2", linkHover: "#b7e4c7", highlight: "#c9184a" },
        summer: { bg: "#be123c", pattern: "#881337", link: "#fda4af", linkHover: "#fecdd3", highlight: "#7209b7" },
        autumn: { bg: "#ca6702", pattern: "#9d0208", link: "#ffc300", linkHover: "#ffd60a", highlight: "#014f86" },
      },
